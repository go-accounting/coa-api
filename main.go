...
func main() {
	...
	router.GET("/api/coa", handler(chartsOfAccounts))
	router.POST("/api/coa", handler(saveChartsOfAccounts))
	router.GET("/api/coa/:coa", handler(getChartOfAccounts))
	router.PUT("/api/coa/:coa", handler(saveChartsOfAccounts))
	router.GET("/api/coa/:coa/accounts", handler(accounts))
	router.POST("/api/coa/:coa/accounts", handler(saveAccount))
	router.GET("/api/coa/:coa/accounts/:account", handler(getAccount))
	router.PUT("/api/coa/:coa/accounts/:account", handler(saveAccount))
